...
def run_search(args):
	...
	time_before_projection=time.time()
	print(f"Time before projections: {time_before_projection-time_start}")
	projection_array = run_projection(angle_starfile,mrc_model,True,False,True,device_id,model_star)
	print(f"Time after projections: {time.time()-time_start}")
	## end projection
	...
	print(f"Time after mask generation: {time.time()-time_start}")
	# read the model star
	...
	print(f"Time after reading p_mline: {time.time()-time_start}")
	p_DFU_index=-1
	p_DFV_index=-1
	p_DFA_index=-1
	p_PSI_index=-1
	...
	print(f"Time after generating templates: {time.time()-time_start}")
