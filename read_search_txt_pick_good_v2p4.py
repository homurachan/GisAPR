...
# changelog v2p4
# Now print the distribution of good/bad particles.
...
if __name__== "__main__":
	...
	Range_high = 5.0
	Range_step = 0.1
	Range_length = int((Range_high-Range_low)/Range_step+1)
	if (draw_histogram):
		threshold_range = np.linspace(Range_low, Range_high, Range_length)
		...
		plt.plot(threshold_range, good_counts, label="Good", linewidth=2)
		plt.plot(threshold_range, bad_counts, label="Bad", linewidth=2)
