	...
	for l in range(Real_Start_Line,Real_End_Line):
		...
		#	start reading the mrcs file.		
			...
			if(p_XSIZE!=XSIZE or p_YSIZE!=YSIZE):
				print(f"X/YSIZE of models and particles mismatch! p_XSIZE = {p_XSIZE}, XSIZE = {XSIZE}, p_YSIZE = {p_YSIZE}, YSIZE = {YSIZE}, p_ZSIZE = {p_ZSIZE}. {p_image_serial_int}@{p_real_filename}")
				break
