...
class MyApp(tk.Tk):
	def __init__(self):
		...
		self.panels = {
			...
			"Run": tk.Label(self.major_region, text="Run Panel", font=("Arial", 14))
		}
	...
	def create_InputFiles_panel(self):
		...
		additional_fields = {
			...
			"Apix": tk.DoubleVar(value=self.input_params.get("Apix", 1.00)),
	...
	def create_simplex_params(self, parent):
		...
		params = {
			...
			"Initial simplex": tk.StringVar(value=self.refine_params.get("Randomize initial simplex", "[15,15,15,15,15,15],[-15,15,15,15,15,15],[-15,-15,15,15,15,15],[-15,-15,-15,15,15,15],\
...
if __name__ == "__main__":
	...
	if(refine_params["algorithm"]=="Grid Search"):
		...
		Grid_refine_warp = Program_RootName / "test_op_GridSearch_refine_rot_trans_v32.py"
	...
	if(refine_params["algorithm"]=="Particle Swarm Optimization (PSO)"):
		...
		PSO_refine_warp = Program_RootName / "test_op_Particle_Swarm_optimization_refine_rot_trans_ver62.py"
